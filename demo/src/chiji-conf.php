...
class Configuration extends \Chigi\Chiji\Project\ProjectConfig {
    ...
    public function getRoadMap() {
        ...
        $road_map->append(new \Chigi\Chiji\Project\LessRoad("LESS", new \Chigi\Component\IO\File("../../bower_components", $this->getProjectRootPath()), new \Chigi\Component\IO\File("../dist/vendor/", $this->getProjectRootPath())));
